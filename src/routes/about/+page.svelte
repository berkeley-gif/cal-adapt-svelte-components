...
<ul>
  <li>
    To reduce the time for developing and iterating on UI components for
    Cal-Adapt.
  </li>
  <li>
    Develop components in isolation so that they may be compatible in other
    Cal-Adapt related projects.
  </li>
</ul>
